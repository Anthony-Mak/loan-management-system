...
<body>
    ...
    <div class="signature-section">
        ...
        <p>By clicking the Next Button hereby duly acknowledge that I have read and understood the Staff Loan Policy attached hereto and agree to the terms and condition set out therein.</p>
        <p>
            Signature(Enter initials): <input type="text" class="signature-input" id="employeeSignature" placeholder="Enter Signature">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.getElementById('acknowledgeButton').addEventListener('click', function() {
                ...
                const signature = document.getElementById('employeeSignature').value;

                if (name && signature) {
                    document.getElementById('acknowledgementMessage').style.display = 'block';
                } else {
                    alert("Please enter both your name and signature.");
                }
